...
export default function BikeGrid({ bikes, isLoading, isFetching, isError, total, newToday, params, onUpdate, pinnedBikes = [], pinnedIds = new Set(), onTogglePin = () => {}, onClearPins = () => {} }) {
