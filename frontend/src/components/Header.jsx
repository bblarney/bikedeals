...
export default function Header({ total, lastScrapedAt, params, onOpenSidebar }) {
  ...
  return (
    <header className="bg-slate-900 px-4 sm:px-6 py-1.5 flex items-stretch gap-3 sm:gap-6 flex-shrink-0">
      ...
      <Link to="/" className="flex items-center gap-1.5">
        ...
        <span className="self-end mb-1.5 text-xs font-semibold tracking-wide px-1.5 py-0.5 rounded-full bg-slate-700 border border-slate-600 text-slate-300">AU</span>
      </Link>
