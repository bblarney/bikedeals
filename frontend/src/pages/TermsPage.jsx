...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      <title>Terms of Use — BikeDeals</title>
      <meta name="description" content="Read the BikeDeals terms of use, including our data accuracy disclaimer, affiliate disclosure, and liability policy." />
      <link rel="canonical" href="https://bikedeals.com.au/terms" />
      ...
      <div className="space-y-8 text-slate-600 leading-relaxed text-sm">
        <section>
          ...
          <p>
            By accessing or using BikeDeals, you agree to be bound by these Terms of Use. If you do
